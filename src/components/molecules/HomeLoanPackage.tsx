...
const commentList = [
  {
    ...
    comment: "Dịch vụ xử lý nhanh, không mất quá nhiều thời gian. Lần đầu vay online mà thấy dễ dàng và uy tín như vậy. Rất đáng tin cậy! Tôi rất hài lòng về VNLENDX.",
  ...
  return (
    <div className="w-full mx-auto flex flex-col items-center justify-center">
      ...
      <div className="mt-10 w-full">
        ...
        <div className="bg-main-color w-full relative mt-6 sm:mt-14 md:mt-20 h-[260px] sm:h-[300px] md:h-[500px] lg:h-[600px]">
          ...
          <div className="text-white text-justify font-light max-w-[500px] absolute left-2/5 sm:left-1/2 top-1/12 px-6">
            <p className="font-bold text-sm sm:text-lg md:text-xl lg:text-2xl mb-6 text-start">Giới thiệu về VNLENDX</p>
      ...
      <div className="max-w-[840px] mt-10 sm:mt-14 md:mt-20">
        <p className="font-bold text-lg sm:text-2xl md:text-4xl leading-6 md:leading-14 text-center">
          <span className="text-main-color">VNLENDX</span> giải quyết vấn đề
          tài chính
        </p>
        <p className="font-bold text-lg sm:text-2xl md:text-4xl leading-6 md:leading-14 text-center">
          cho người dùng
