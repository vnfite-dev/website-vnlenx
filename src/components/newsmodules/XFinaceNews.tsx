...
const VideoItem = ({
  ...
  item: { link: string; title: string; createdAt: string };
}) => {
  ...
  return (
    <div className="item">
      ...
      <div className="view-overlay">
        <div className="txt-header-overlay">{truncateText(item.title, 60)}</div>
    ...
    <header suppressHydrationWarning={false}>
      <div className="view-container">
        <div className="txt-header">
          <span style={{ color: "#FF4142" }}>Vnlendx</span> và khách hàng
        </div>
