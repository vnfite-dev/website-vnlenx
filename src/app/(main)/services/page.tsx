      ...
      <div className="max-w-[1280px] w-full h-full flex flex-col items-start justify-start gap-4 mx-auto mb-10">
        ...
        <div className="w-full mx-auto">
          <p className="text-lg md:text-xl lg:text-2xl text-center font-bold px-4 py-4">
            Thủ tục và các giấy tờ cần chuẩn bị
          </p>
          <div className="flex flex-col sm:flex-row-reverse gap-4 mt-2">
            <div className="w-full sm:w-1/2 px-4 md:p-6 lg:p-8">
              <p className="text-sm sm:text[16px] md:text-lg lg:text-xl font-bold text-center">
                Thủ tục
              </p>
              <p className="text-sm md:text-[16px] lg:text-lg my-4 sm:my-6">
                Bạn vui lòng thực hiện theo các bước dưới đây để được giải ngân
                nhanh nhất:
              </p>
              {procedureList.map((item, index) => (
                ...
                >
                  ...
                  <p className="text-sm md:text-[16px] lg:text-lg">
                    <span className="font-bold">Bước {index + 1}:</span> {item}
                  </p>
                </div>
              ))}
            </div>
            <div className="w-full sm:w-1/2 px-4 md:p-6 lg:p-8">
              ...
              <p className="text-sm md:text-[16px] lg:text-lg my-4 sm:my-6">
                Bạn vui lòng chuẩn bị các giấy tờ sau mang ra cơ sở gần nhất để
                giải ngân{" "}
              </p>
